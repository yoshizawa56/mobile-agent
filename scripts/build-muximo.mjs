...
const output = process.env.MUXIMO_BUILD_OUTPUT ?? "dist/muximo";
const target = process.env.MUXIMO_BUILD_TARGET;
...
const buildArgs = ["build", "apps/muximo-cli/src/index.ts", "--compile", "--minify"];
