...
export function ControlRoomView({ viewModel: controlRoomViewModel, layoutVariant = "ghost" }: { viewModel: ControlRoomViewModel; layoutVariant?: PaneLayoutOverlayVariant }) {
